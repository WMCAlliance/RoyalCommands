...
public class SCmdDelete extends SubCommand<CmdWorldManager> {
    ...
    public SCmdDelete(final RoyalCommands instance, final CmdWorldManager parent) {
        super(instance, parent, "delete", true, "Unloads and deletes a world. If eject is specified, will kick all players on the world.", "<command> [name] (eject)", new String[0], new Short[]{TabCommand.CompletionType.WORLD.getShort()});
    }
