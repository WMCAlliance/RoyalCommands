...
public class SCmdCheck extends SubCommand<CmdVip> {

    public SCmdCheck(final RoyalCommands instance, final CmdVip parent) {
        super(instance, parent, "check", true, "Check if a player is a VIP.", "<command> (player)", new String[0], new Short[]{CompletionType.ONLINE_PLAYER.getShort()});
    }
    ...
    public boolean runCommand(final CommandSender cs, final Command cmd, final String label, final String[] eargs, final CommandArguments ca) {
        ...
        String inListStr = inList ? "" : "not ";
        MessageColor inListColor = inList ? MessageColor.POSITIVE : MessageColor.NEGATIVE;
        ...
        tc.addExtra(TextComponent.fromLegacy(" " + inListColor + "is " + inListStr + "in the VIP list."));
