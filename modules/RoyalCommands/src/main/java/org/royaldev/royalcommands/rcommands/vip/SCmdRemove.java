...
public class SCmdRemove extends SubCommand<CmdVip> {

    public SCmdRemove(final RoyalCommands instance, final CmdVip parent) {
        super(instance, parent, "remove", true, "Remove a player from the VIP list.", "<command> (player)", new String[0], new Short[]{CompletionType.ONLINE_PLAYER.getShort()});
    }
    ...
    public boolean runCommand(final CommandSender cs, final Command cmd, final String label, final String[] eargs, final CommandArguments ca) {
        ...
        tc.addExtra(TextComponent.fromLegacy(" " + MessageColor.POSITIVE.bc() + "from the VIP list."));
